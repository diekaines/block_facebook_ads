// ==UserScript==
// @name         FB remove ads me SVG
// @namespace    example.org
// @version      0.5
// @description  FB remove ads me SVG
// @author       You
...
function remove_ads(el) {
    ...
    var kot = document.querySelectorAll(' span svg use   ').forEach(function(main_span_sponsored){
    ...
    if(!is_element_in_viewport ( main_span_sponsored ) ) {
      ...
      // console.log('kalledss')
       ...
       //  console.log(main_span_sponsored.getAttribute('xlink:href'));
var link_text_id = main_span_sponsored.getAttribute('xlink:href').replace('#','');

       // console.log(link_text_id);

        var is_text_value_Sponsored   = document.querySelectorAll('svg text#'+ link_text_id )[0].innerHTML;
        // console.log("ID to Text " , is_text_value_Sponsored);
